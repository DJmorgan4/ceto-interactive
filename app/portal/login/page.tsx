  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6" style={{ backgroundColor: THEME.bg }}>
      <div className="fixed inset-0 z-0 pointer-events-none" style={{
        backgroundImage: `radial-gradient(circle at 20% 50%, rgba(47,93,140,0.10) 0%, transparent 55%), radial-gradient(circle at 80% 70%, rgba(79,122,106,0.08) 0%, transparent 55%)`
      }} />
          ...
          {Array.from({ length: 9 }).map((_, i) => {
            ...
            return (
              <path key={i}
                ...
                fill="none" stroke={`rgba(20,35,55,${Math.max(o,0.02)})`} strokeWidth="1.15" />
            );
          })}
        </svg>
      </div>
      ...
      <div className="relative z-10 w-full max-w-sm">
        <div className="text-center mb-10">
          ...
          <div className="text-[10px] font-light mt-2 tracking-[0.30em] uppercase" style={{ color: 'rgba(20,35,55,0.40)' }}>
            Private Operations Access
          </div>
        </div>

        <div className="rounded-2xl p-8" style={{ backgroundColor: THEME.surfaceStrong, border: `1px solid ${THEME.border}`, backdropFilter: 'blur(12px)' }}>
          <div className="mb-5">
            <label className="block text-[11px] font-light mb-2 tracking-widest uppercase" style={{ color: 'rgba(20,35,55,0.45)' }}>
              Password
            </label>
            <input
              type="password"
              ...
              style={{ backgroundColor: 'rgba(20,35,55,0.04)', border: `1px solid ${error ? 'rgba(224,122,95,0.55)' : 'rgba(20,35,55,0.14)'}`, color: THEME.ink }}
            />
            {error && (
              <div className="text-xs font-light mt-2 flex items-center gap-1.5" style={{ color: THEME.sunset }}>
        ...
        <div className="text-center mt-6">
          <a href="/" className="text-[11px] font-light" style={{ color: 'rgba(20,35,55,0.35)' }}>
            ← cetointeractive.com
          </a>
        </div>
      </div>
